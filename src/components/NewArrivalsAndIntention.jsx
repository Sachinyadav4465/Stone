...
// 1. रीएक्ट राउटर से useNavigate इम्पोर्ट किया नेविगेशन के लिए
import { useNavigate } from "react-router-dom";
// 2. कार्ट हुक को इम्पोर्ट किया
...
const NewArrivalsAndIntention = () => {
    ...
    const products = [
        {
            ...
            image: "https://i.pinimg.com/1200x/10/04/f3/1004f3b4b0ec5e76a910803078b96528.jpg",
            price: 1999,
            oldPrice: "2,499",
            discount: "20% OFF",
            review: 128
        },
        {
            ...
            image: "https://i.pinimg.com/1200x/1e/05/ee/1e05ee1af47ba14e60a192d3f2f177f5.jpg",
            price: 2299,
            oldPrice: "2,999",
            discount: "23% OFF",
            review: 210
        },
        {
            ...
            image: "https://i.pinimg.com/736x/e7/a9/ea/e7a9ea659fbed532a1372066b3e23b95.jpg",
            price: 1799,
            oldPrice: "2,399",
            discount: "25% OFF",
            review: 160
        },
        {
            ...
            image: "https://i.pinimg.com/1200x/80/1a/b6/801ab691b5d6a5da253560cf8bc16fe7.jpg",
            price: 499,
            oldPrice: "699",
            discount: "20% OFF",
            review: 167
        },
        {
            ...
            image: "https://i.pinimg.com/736x/59/d3/11/59d311fb4a31c170ece74a5e3936ee6a.jpg",
            price: 599,
            oldPrice: "899",
            discount: "22% OFF",
            review: 134
        ...
        {
            id: 8,
            title: "Citrine Crystal Tree Large",
            image: "https://i.pinimg.com/736x/e7/a9/ea/e7a9ea659fbed532a1372066b3e23b95.jpg",
            price: 1799,
            oldPrice: "2,399",
            discount: "25% OFF",
    ...
    const intentionData = [
        { id: "wealth", icon: <RiMoneyDollarCircleLine />, title: "WEALTH & ABUNDANCE" },
        { id: "love", icon: <GiLovers />, title: "LOVE & RELATIONSHIP" },
        { id: "protection", icon: <TbShieldCheck />, title: "PROTECTION" },
        { id: "career", icon: <RiSuitcaseLine />, title: "CAREER & SUCCESS" },
        { id: "peace", icon: <GiPeaceDove />, title: "PEACE & HARMONY" },
        { id: "health", icon: <GiHealthNormal />, title: "HEALTH & WELLNESS" },
        { id: "spiritual", icon: <GiCrystalGrowth />, title: "SPIRITUAL GROWTH" },
        { id: "positive", icon: <GiInnerSelf />, title: "POSITIVE ENERGY" }
    ];
                ...
                <div className="container-fluid px-lg-5">
                    ...
                    <div className="position-relative slider-container-box">
                        ...
                        >
                            {products.map((item) => (
                                <div 
                                    className="product-card card product-main-card bg-dark text-white" 
                                    key={item.id} 
                                    style={{ minWidth: '280px', border: '1px solid #222', cursor: 'pointer' }}
                ...
                <div className="container-fluid px-lg-5">
                    ...
                    <div className="intention-grid">
                        {intentionData.map((item) => (
                            <div className="intent-box" key={item.id}>
                                <div className="intent-circle">{item.icon}</div>
                                <p>{item.title}</p>
                            </div>
                        ))}
                    </div>
                    <div className="energy-banner">
                        <div className="row align-items-center">
                            <div className="col-lg-6">
                                <img
                                    src="https://i.pinimg.com/736x/10/0d/00/100d00670f30882462475d3b81d63735.jpg"
                                    alt="banner"
                                />
                            </div>
                            <div className="col-lg-6">
                                <h2>BRING POSITIVE ENERGY INTO YOUR LIFE</h2>
                                <p>Enhance your space, mind and soul with the natural power of crystals.</p>
                                <button>
                                    EXPLORE COLLECTION
                                    <BsArrowRight />
                                </button>
...
export default NewArrivalsAndIntention;